...
# Address spaces hiscore.dat can name. `program` records carry the CPU's own
# address (copied from Arcade-JalecoMS1Z_MiSTer). MAME 0.289 also writes records
# relative to a memory SHARE --
#     lomakai:
#     makaiden:
